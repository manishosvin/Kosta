...
class WCFM_Follow_Shortcode {
	...
	static public function output( $attr ) {
		...
		<div class="wcfm_ele_wrapper wcfm_follow_widget">
			...
			<a href="#" class="wcfm_follow_me" data-count="<?php echo $followers; ?>" data-vendor_id="<?php echo $vendor_id; ?>" data-user_id="<?php echo $user_id; ?>" style="<?php echo $button_style; ?>"><span class="fa fa-child"></span>&nbsp;&nbsp;<span class="add_enquiry_label wcfm_follow_me_lable"><?php echo $follow_button_label; ?></span></a>
			<?php if( $base_color ) { ?>
