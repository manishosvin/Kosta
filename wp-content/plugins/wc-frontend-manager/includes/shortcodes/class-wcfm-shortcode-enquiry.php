...
class WCFM_Enquiry_Shortcode {
	...
	static public function output( $attr ) {
		...
		<div class="wcfm_ele_wrapper wcfm_enquiry_widget">
			...
			<a href="#" class="wcfm_catalog_enquiry" data-store="<?php echo $vendor_id; ?>" data-product="<?php echo $product_id; ?>" style="<?php echo $button_style; ?>"><span class="fa fa-question-circle-o"></span>&nbsp;&nbsp;<span class="add_enquiry_label"><?php echo $ask_question_label; ?></span></a>
			<?php if( $base_color ) { ?>
