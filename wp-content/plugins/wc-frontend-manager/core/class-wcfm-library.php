  ...
  /**
	...
	*/
	public function load_daterangepicker_lib() {
	  global $WCFM;
	  wp_enqueue_script( 'wcfm-moment-js', $WCFM->plugin_url . 'includes/libs/date-range-picker/moment.min.js', array(), $WCFM->version, true );
	...
	public function wcfm_date_range_picker_field(){
		...
		<div class="wcfm-date-range-field">
			<input type="text" name="wcfm-date-range" class="wcfm-date-range" autocomplete="off" value="<?php _e( 'Choose Data Range', 'wc-frontend-manager' ); ?> ....">
