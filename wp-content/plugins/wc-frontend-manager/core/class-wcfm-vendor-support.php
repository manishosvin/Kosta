  ...
  function vendors_wcfm_menus( $menus ) {
	...
	function wcfm_associate_vendor( $product_id ) {
		...
		if( $is_marketplace ) {
			...
			<div class="page_collapsible products_manage_vendor_association simple variable grouped external booking" id="wcfm_products_manage_form_vendor_association_head"><label class="fa fa-user-alt fa-user-o"></label><?php _e('Vendor', 'wc-frontend-manager'); ?><span></span></div>
