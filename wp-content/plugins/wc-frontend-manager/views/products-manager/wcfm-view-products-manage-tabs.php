...
?>
			<?php if( apply_filters( 'wcfm_is_allow_inventory', true ) && apply_filters( 'wcfm_is_allow_pm_inventory', true ) ) { ?>
					<!-- collapsible 1 -->
					<div class="page_collapsible products_manage_inventory <?php echo apply_filters( 'wcfm_pm_block_class_stock', 'simple variable grouped external non-job_package non-resume_package non-auction non-accommodation-booking' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_stock', '' ); ?>" id="wcfm_products_manage_form_inventory_head"><label class="fa fa-database"></label><?php _e('Inventory', 'wc-frontend-manager'); ?><span></span></div>
					<div class="wcfm-container simple variable grouped external non-job_package non-resume_package non-auction non-accommodation-booking <?php echo apply_filters( 'wcfm_pm_block_custom_class_stock', '' ); ?>">
				...
				<?php if( apply_filters( 'wcfmu_is_allow_downloadable', true ) && apply_filters( 'wcfmu_is_allow_pm_downloadable', true ) ) { ?>
					<!-- collapsible 2 -->
					<div class="page_collapsible products_manage_downloadable simple downlodable non-variable-subscription non-redq_rental non-appointment" id="wcfm_products_manage_form_downloadable_head"><label class="fa fa-cloud-download"></label><?php _e('Downloadable', 'wc-frontend-manager'); ?><span></span></div>
					<div class="wcfm-container simple downlodable non-variable-subscription non-redq_rental non-appointment">
						<div id="wcfm_products_manage_form_downloadable_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_fields_downloadable', array(  
																																																	"downloadable_files" => array('label' => __('Files', 'wc-frontend-manager') , 'type' => 'multiinput', 'class' => 'wcfm-text wcfm_ele simple downlodable', 'label_class' => 'wcfm_title', 'value' => $downloadable_files, 'options' => array(
																																																													...
																																																													"file" => array('label' => __('File', 'wc-frontend-manager'), 'type' => 'upload', 'mime' => 'Uploads', 'class' => 'wcfm-text wcfm_ele simple downlodable downlodable_file', 'label_class' => 'wcfm_ele wcfm_title simple downlodable', 'custom_attributes' => array( 'required' => 1 ) ),
				...
				<!-- collapsible 4 -->
				<div class="page_collapsible products_manage_shipping <?php echo apply_filters( 'wcfm_pm_block_class_shipping', 'simple variable nonvirtual booking non-accommodation-booking' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_shipping', '' ); ?>" id="wcfm_products_manage_form_shipping_head"><label class="fa fa-truck"></label><?php _e('Shipping', 'wc-frontend-manager'); ?><span></span></div>
				<div class="wcfm-container simple variable nonvirtual booking non-accommodation-booking <?php echo apply_filters( 'wcfm_pm_block_custom_class_shipping', '' ); ?>">
				...
				<?php if( apply_filters( 'wcfm_is_allow_tax', true ) && apply_filters( 'wcfm_is_allow_pm_tax', true ) ) { ?>
				<?php if ( wc_tax_enabled() ) { ?>
				<!-- collapsible 5 -->
				<div class="page_collapsible products_manage_tax <?php echo apply_filters( 'wcfm_pm_block_class_tax', 'simple variable' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>" id="wcfm_products_manage_form_tax_head"><label class="fa fa-money fa-money-bill-alt"></label><?php _e('Tax', 'wc-frontend-manager'); ?><span></span></div>
				<div class="wcfm-container simple variable <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>">
				...
				<!-- collapsible 6 -->
				<div class="page_collapsible products_manage_attribute <?php echo apply_filters( 'wcfm_pm_block_class_attributes', 'simple variable external grouped booking' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_attributes', '' ); ?>" id="wcfm_products_manage_form_attribute_head"><label class="fa fa-server"></label><?php _e('Attributes', 'wc-frontend-manager'); ?><span></span></div>
						...
						<?php
						 $WCFM->wcfm_fields->wcfm_generate_form_field( array(  
																																	"variations" => array('type' => 'multiinput', 'class' => 'wcfm_ele variable variable-subscription', 'label_class' => 'wcfm_title', 'value' => $variations, 'options' => 
																																			...
																																			"is_virtual" => array('label' => __('Virtual', 'wc-frontend-manager'), 'type' => 'checkbox', 'value' => 'enable', 'class' => 'wcfm-checkbox wcfm_ele variable variable-subscription variation_is_virtual_ele', 'label_class' => 'wcfm_title checkbox_title'),
																																			...
																																			"regular_price" => array('label' => __('Regular Price', 'wc-frontend-manager') . '(' . get_woocommerce_currency_symbol() . ')', 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_half_ele variable', 'label_class' => 'wcfm_title wcfm_ele wcfm_half_ele_title variable', 'attributes' => array( 'min' => '0.1', 'step'=> '0.1' ) ),
																																			"sale_price" => array('label' => __('Sale Price', 'wc-frontend-manager') . '(' . get_woocommerce_currency_symbol() . ')', 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_half_ele variable variable-subscription', 'label_class' => 'wcfm_title wcfm_ele wcfm_half_ele_title variable variable-subscription', 'attributes' => array( 'min' => '0.1', 'step'=> '0.1' ) ),
																																			...
																																			"stock_qty" => array('label' => __('Stock Qty', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_half_ele variable variable-subscription variation_non_manage_stock_ele', 'label_class' => 'wcfm_title wcfm_half_ele_title variation_non_manage_stock_ele', 'attributes' => array( 'min' => '1', 'step'=> '1' ) ),
				...
				<?php if( $allow_advanced = apply_filters( 'wcfm_is_allow_linked', true ) ) { ?>
					...
					<div class="page_collapsible products_manage_linked <?php echo apply_filters( 'wcfm_pm_block_class_linked', 'simple variable external grouped' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_linked', '' ); ?>" id="wcfm_products_manage_form_linked_head"><label class="fa fa-link"></label><?php _e('Linked', 'wc-frontend-manager'); ?><span></span></div>
