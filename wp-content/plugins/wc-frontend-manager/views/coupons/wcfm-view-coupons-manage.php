	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('post-new.php?post_type=shop_coupon'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager' ); ?>"><span class="fa fab fa-wordpress fa-wordpress-simple"></span></a>
				<?php
			}
				...
				<div id="coupons_manage_general_expander" class="wcfm-content">
						<?php
							...
							if( WCFM_Dependencies::dokanpro_plugin_active_check() ) {
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field( array ( "show_on_store" => array('label' => __('Show on store', 'dokan') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'hints' => __('Check this box if you want to show this coupon in store page.', 'dokan'), 'dfvalue' => $show_on_store ) ) );
							}
						?>
				</div>
			</div>
