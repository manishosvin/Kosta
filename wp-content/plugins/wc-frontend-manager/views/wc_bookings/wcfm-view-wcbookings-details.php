	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('post.php?post='.$booking_id.'&action=edit'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager' ); ?>"><span class="fa fab fa-wordpress fa-wordpress-simple"></span></a>
				<?php
			}
		...
		<div class="wcfm-container">
			<div id="bookings_details_general_expander" class="wcfm-content">
				...
				<?php if ( $order && is_a( $order, 'WC_Order' ) ) { ?>
					<p class="form-field form-field-wide">
						<label for="booking_date"><?php _e( 'Booking Cost:', 'wc-frontend-manager' ) ?></label>
						<?php
			...
			<div id="bookings_details_booking_expander" class="wcfm-content">
				...
				<?php if( apply_filters( 'wcfm_is_allow_booking_schedule_update', true ) ) { ?>
					<form id="wcfm_wcb_schedule_update_form">
						...
						<p class="form-field form-field-wide">
							<?php 
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 'booking_start_date' => array(
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 'booking_start_time' => array(
						...
						<p class="form-field form-field-wide">
							<?php 
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 'booking_end_date' => array(
																																																'id'          => 'booking_end_date',
																																																'type'        => 'text',
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 'booking_end_time' => array(
																																																'id'          => 'booking_end_time',
																																																'type'        => 'text',
						...
						<p class="form-field form-field-wide">
							<?php 
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( '_booking_all_day' => array(
																																																'id'          => '_booking_all_day',
																																																'type'        => 'checkbox',
			...
			<div id="bookings_details_customer_expander" class="wcfm-content">
				...
				if ( $order_id && ( $order = wc_get_order( $order_id ) ) ) {
					...
					if( apply_filters( 'wcfm_allow_view_customer_email', true ) && $order->get_billing_email() ) {
						echo '<tr>';
							echo '<th>' . __( 'Billing Email:', 'wc-frontend-manager' ) . '</th>';
							echo '<td>';
