...
if( apply_filters( 'wcfm_is_pref_enquiry_tab', true ) ) {
	...
	<?php if( !apply_filters( 'wcfm_is_pref_enquiry_button', true ) ) { ?>
		...
		<p><span class="add_enquiry" data-store="<?php echo $vendor_id; ?>" data-product="<?php echo $product_id; ?>"><span class="fa fa-question-circle fa-question-circle-o"></span>&nbsp;<span class="add_enquiry_label"><?php _e( $wcfm_enquiry_button_label, 'wc-frontend-manager' ); ?></span></span></p>
		<div class="wcfm-clearfix"></div>
	<?php } ?>
<?php } ?>
