	...
	public function processing() {
		...
		if ( !empty( $order_summary ) ) {
			...
			foreach ( $order_summary as $order ) {
				...
				$wcfm_orders_json_arr = apply_filters( 'wcfm_orders_custom_columns_data', $wcfm_orders_json_arr, $index, $order->ID, $order, $the_order );
				...
				$wcfm_orders_json_arr[$index][] =  apply_filters ( 'wcfmmarketplace_orders_actions', $actions, $user_id, $order, $the_order );
